...
export default function Button({
    ...
    const baseStyles = "relative overflow-hidden inline-flex items-center justify-center whitespace-nowrap px-8 py-4 text-base font-bold rounded-full transition-all duration-300 group hover:scale-105 active:scale-95";

    const variants = {
        primary: "bg-primary text-dark hover:bg-white hover:text-black primary-glow-md hover:shadow-[0_0_30px_rgba(255,255,255,0.4)]",
